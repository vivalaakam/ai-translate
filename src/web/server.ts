...
import { OLLAMA_DEFAULT_URL, DEFAULT_MODEL } from '../utils/constants.js';
 ...
 */
export function startServer(port: number = 3000, options?: { ollamaUrl?: string; defaultModel?: string }): http.Server {
